...
public class UserAuthenticationService {
  ...
  /**
   * Checks if there are duplicates of the username and email id in the database.
   * Generates uuid for the user
   * Password is encrypted with salt
   *
   * @throws SignUpRestrictedException - if duplicate entries exist
   */
   ...
   * @param password 
   * @return
   * @throws AuthenticationFailedException - On invalid authentication
   */
  @Transactional(propagation = Propagation.REQUIRED)
   ...
   * @param accessToken 
   * @return 
   * @throws SignOutRestrictedException - On invalid authentication details
   */
  @Transactional(propagation = Propagation.REQUIRED)
