...
public class UserController {
  ...
  /**
   * Create a new user based on the details provided
   * @return SignupUserResponse - uuid of the user is generated.
   * @throws SignUpRestrictedException - if a duplicate entry exists
   */
...
/**
   * Authenticate User Login details for login
  ...
  /**
   * Authorize user log out
   *
   * @param accessToken - AccessToken to check authorization
   * @return - uuid of logged out user
   * @throws SignOutRestrictedException - On invalid authorization or user not logged in
   */
  @RequestMapping(
      method = RequestMethod.POST,
      path = "/user/signout",
